...
const List<Doodle> doodles = [
  Doodle(
      ...
      doodle: "https://cdn.mos.cms.futurecdn.net/wnt8XoAdv5GCk5NdC7SGwK.jpg",
      icon: Icon(Icons.star, color: Colors.white),
      iconBackground: Colors.cyan),
  Doodle(
      name: "Astronomers Detect First Split-Second of the Universe",
      time: "",
      content:
      ...
      doodle: "https://cdn.mos.cms.futurecdn.net/YdXR3NJg2UWug3d6MNb848.jpg",
      icon: Icon(
        Icons.exposure,
        color: Colors.white,
      ),
  ...
  Doodle(
      name: "After Big Bang Came Moment of Pure Chaos, Study Finds",
      time: "",
      content:
      ...
      doodle: "https://cdn.mos.cms.futurecdn.net/oPp4zfkhjqMCi6fuQT2d4A.jpg",
      icon: Icon(
        Icons.visibility,
  ...
  Doodle(
      name: "Star Observations Could Solve Cosmic Riddle",
      time: "",
      content:
      ...
      doodle: "https://cdn.mos.cms.futurecdn.net/XxFrUH2jU5Dvqo3fJf6Csa.jpg",
      icon: Icon(
  ...
  Doodle(
      name: "New Model of the Early Universe",
      time: "",
      content:
      ...
      doodle: "https://cdn.mos.cms.futurecdn.net/XAWeCbTZCZ9NS68Vs9Lx2j.jpg",
      icon: Icon(
        Icons.healing,
        color: Colors.white,
      ),
  ...
  Doodle(
      name: "Hubble Lifts Fog on Early Universe",
      time: "",
      content:
      ...
      doodle: "https://cdn.mos.cms.futurecdn.net/8DmQdHn5oEmtmdkBtr5WoR.jpg",
      icon: Icon(
        Icons.blur_circular,
        color: Colors.white,
      ),
  ...
  Doodle(
      name: "Explanation of Dark Matter Might Lie in Origin of Stars",
      time: "",
      content:
      ...
      doodle: "https://cdn.mos.cms.futurecdn.net/6uB3D9um2GnyK2Se7AF3fi.jpg",
      icon: Icon(
        Icons.category,
        color: Colors.white,
      ),
  ...
  Doodle(
      name: "Some of the Universe's First Galaxies Discovered",
      time: "",
      content:
      ...
      doodle: "https://cdn.mos.cms.futurecdn.net/MszuCSYQkVe9Y39mNGpfGP.jpg",
      icon: Icon(
        Icons.navigation,
        color: Colors.white,
        size: 32.0,
  ...
  Doodle(
      name: "Farthest Galaxy Found, Perhaps",
      time: "",
      content:
      ...
      doodle:"https://cdn.mos.cms.futurecdn.net/YoNBaoXjzVmTP9cZ6pXjAQ.jpg",
            icon: Icon(
  ...
  Doodle(
      name: "Violent Explosion Is Most Distant Object Ever Seen",
      time: "",
      content:
      ...
      doodle:
          "https://cdn.mos.cms.futurecdn.net/hZY7ngJZiSLQXuLR3hKV45.jpg",
      icon: Icon(
        Icons.map,
        color: Colors.white,
        size: 32.0,
      ...
      Doodle(
      name: "Black Holes Gave Our Baby Universe a Fever",
      time: "",
      content:
          "He is primarily known today for his maps and charts collected in his Kitab-ı Bahriye (Book of Navigation), a book that contains detailed information on navigation, as well as very accurate charts (for their time) describing the important ports and cities of the Mediterranean Sea. He gained fame as a cartographer when a small part of his first world map (prepared in 1513) was discovered in 1929 at the Topkapı Palace in Istanbul. His world map is the oldest known Turkish atlas showing the New World, and one of the oldest maps of America still in existence anywhere (the oldest known map of America that is still in existence is the map drawn by Juan de la Cosa in 1500). Piri Reis' map is centered on the Sahara at the latitude of the Tropic of Cancer.",
      doodle:
          "https://cdn.mos.cms.futurecdn.net/LxGTqRghbGZChG9a5BFVg3.jpg",
      icon: Icon(
        Icons.map,
        color: Colors.white,
        size: 32.0,
